...
public class ShareDialog extends DialogFragment implements ShareItemsAdapter.OnShareActionSelect {
    ...
    private Integer dialogMessageTintColor;
    private Integer dialogMessageTintBackground;
    ...
    protected void bindViews(View layout) {
        ...
        if (headerLayoutID == null || headerLayoutID == 0)
            ...
            this.messageView = (TextView) layout.findViewById(R.id.tvMessage);
    }
    ...
    private void setUpMessage() {
        ...
        if (dialogTitleTintColor != null && dialogTitleTintColor != 0)
            messageView.setTextColor(dialogTitleTintColor);

        if (dialogTitleTintBackground != null)
            messageView.setBackgroundColor(dialogTitleTintBackground);

        if (dialogTitle != null && !dialogTitle.equals(""))
            messageView.setText(dialogTitle);
        else
            messageView.setText(R.string.default_dialog_title);
    }
